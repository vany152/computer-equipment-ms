...
public abstract class SalesRepositoryTestBase : RepositoryTestBase<Sale, int>
{
    protected SalesRepositoryTestBase()
    {
        Repository = new SalesNpgsqlRepository(ConnectionString);
    }
