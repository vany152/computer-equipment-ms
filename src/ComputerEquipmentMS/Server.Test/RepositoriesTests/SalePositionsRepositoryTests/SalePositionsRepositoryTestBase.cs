...
public class SalePositionsRepositoryTestBase : RepositoryTestBase<SalePosition, int>
{
    public SalePositionsRepositoryTestBase()
    {
        Repository = new SalePositionsNpgsqlRepository(ConnectionString);
    }
